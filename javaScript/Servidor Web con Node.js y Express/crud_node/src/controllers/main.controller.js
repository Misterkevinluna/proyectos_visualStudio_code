...
El __dirname nos trae la ruta completa de dicho archivo(main.router.js) en esta maquina*/
// const index =  (req, res)=>{
//     res.sendFile(path.resolve(__dirname, '../../private/index.html'));
// }

const index =  (req, res)=>{
    res.render("index");//Este index que esta renderizando hace referencia al del src\views\index.ejs
}
