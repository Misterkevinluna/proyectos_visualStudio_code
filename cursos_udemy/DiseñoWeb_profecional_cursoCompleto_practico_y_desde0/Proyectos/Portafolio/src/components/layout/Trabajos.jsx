...
import trabajos from '../data/trabajosData';
import '../../assets/css/style/trabajos.css';
import Modal from '../Modal';

const Trabajos = () => {
    const [categoriaSeleccionada, setCategoriaSeleccionadad] = useState('todos');
    const [trabajosFiltrados, setTrabajosFiltrados] = useState(trabajos);
    const [estadoModal, setEstadoModal] = useState(false);
    const [trabajoSeleccionado, setTrabajoSeleccionado] = useState(false);

    const handleChange = (e) => {
        const categoria = e.target.id;
        setCategoriaSeleccionadad(categoria);
    ...
    return (
        <>
            ...
            {/*Al colocar && indicamos que si estadoModal es true carga el componente Modal sino entonces el codigo despues de && no se ejecutará*/}
