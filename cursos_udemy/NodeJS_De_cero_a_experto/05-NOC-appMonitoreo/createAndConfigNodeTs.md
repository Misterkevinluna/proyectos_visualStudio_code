# 🚀 Forma correcta de configurar un proyecto de Node.js con TypeScript usando ts-node-dev (2026)
...
- [¿Qué hace ts-node-dev?](#-qué-hace-ts-node-dev)
...
| Flag | Descripción |
|---|---|
| `--respawn` | Reinicia el proceso automáticamente cuando detecta cambios |
| `--transpile-only` | Compila más rápido (sin validación completa de tipos) |
