...
module.exports = function buildLogger(service){
    return {
        log: (message) =>{//la variable donde se almacena a la función buildLogger que se esta exportando se pude uar para pasarle el parametro al atributo 'log' del json
